...
import 'package:hive/hive.dart'; // ✅ استخدم hive، مش hive_flutter
import 'worker_action_model.dart'; // ✅ استيراد WorkerAction

part 'worker_model.g.dart';

@HiveType(typeId: 7) // ✅ استخدم typeId فريد (7 مثلاً)
